            ...
            <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <a v-for="item in navigation" :key="item.name" :href="item.href"
                        class="text-sm font-semibold leading-6 text-gray-900 relative after:content-[''] after:bg-indigo-600 after:h-1 after:w-0 after:left-0 after:-bottom-1 after:rounded-xl after:absolute after:transition-all after:duration-300 hover:after:w-full">{{ item.name }}</a>
                </div>
                <div class="hidden lg:flex lg:flex-1 lg:justify-end lg:flex-nowrap">
                    <a href="#" class="flex mr-1 text-sm font-semibold leading-6 text-gray-900 flex-nowrap">Log in &nbsp; <img src="../assets/icons/161-trending-flat-outline.gif" alt="" width="20"></a>
                </div>
            </nav>
